package com.example.blinknotes.presentation.ui.Screens.profile.settingProfile
...
fun LinkScreen(
    ...
    Scaffold(
        ...
        Column(
            ...
            Button(
                onClick = {
                    val userId = viewModelProfile.loggedInUserId
                    if (userId != null) {
                        viewModelProfile.updateSocialLinks(
                            userId = userId,
